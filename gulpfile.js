...
function copyIndexHtml() {
  return gulp.src(`${DEST_PATH}/index.html`)
    .pipe(gulp.dest(`${DEST_PATH}/pages/`))
}

function copyIndexJson() {
  return gulp.src(`${SOURCE_PATH}/pages/index.json`)
    .pipe(gulp.dest(`${DEST_PATH}/pages/`))
}

gulp.task('default', gulp.parallel(copyAppJson, copyMockJson, copyAssets, copyIndexHtml, ))
